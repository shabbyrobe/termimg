...
func firstRune(s string) (r rune, n int, err error) {
	...
	return 0, 0, fmt.Errorf("rune not found")
}
...
var DefaultPatternSet = defaultPatternSet

// defaultPatternSet is exported indirectly so it doesn't pollute the godoc
var defaultPatternSet = &PatternSet{
	Default: Pattern{lowerHalfBitmap, '▄'},
